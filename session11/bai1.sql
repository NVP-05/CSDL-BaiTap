...
from employees 
where salary >= 15000000 with check option;
...
/*
Các nhân viên làm việc tại "Chi nhánh Hà Nội" đã bị xóa hoàn toàn khỏi bảng Employees.
Việc xóa dữ liệu này không ảnh hưởng đến các nhân viên ở các chi nhánh khác. 
Những nhân viên thuộc "Chi nhánh TP.HCM" hoặc "Chi nhánh Đà Nẵng" vẫn tồn tại trong bảng.
*/